...
/**
 * The live skill environment (plan S14.2, ticket #38): the known agent
 * tool names and generator names the manifest validator resolves
 * against. Kept in its own module so the catalog, the authoring helper,
 * and the registry share one frozen environment without import cycles.
 */
