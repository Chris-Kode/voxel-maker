...
const STRUCTURAL_CHECKS: SkillManifest['evaluation']['structuralChecks'] = Object.freeze([
  Object.freeze({"name": "occupied-voxel-count-in-range", "description": "The figure is a solid, non-trivial object.", "options": {"region": {"min": [0, 0, 0], "max": [16, 16, 16]}, "min": 150, "max": 60000}} as const),
  Object.freeze({"name": "symmetric-along-axis", "description": "The figure is symmetric across the sagittal plane.", "options": {"axis": "x", "plane": 8, "region": {"min": [0, 0, 0], "max": [16, 16, 16]}}} as const),
  Object.freeze({"name": "node-count-in-range", "description": "The figure stays a small scene.", "options": {"min": 1, "max": 24}} as const)]);
const VISUAL_BASELINES: SkillManifest['evaluation']['visualBaselines'] = Object.freeze([
  Object.freeze({"view": "perspective", "description": "The figure fills a visible share of the frame.", "minSilhouetteRatio": 0.05, "maxSilhouetteRatio": 0.9} as const),
  Object.freeze({"view": "front", "description": "The front view shows the whole figure.", "minSilhouetteRatio": 0.04, "maxSilhouetteRatio": 0.9} as const),
  Object.freeze({"view": "side", "description": "The side view shows depth.", "minSilhouetteRatio": 0.02, "maxSilhouetteRatio": 0.9} as const)]);

const MANIFEST: SkillManifest = {
  manifestVersion: 1,
  name: "skill.humanoid",
  version: "1.0.0",
  description: "Creation skill for representative humanoid figures: head, torso, arms, and legs built from generic symmetry and limb-chain generators.",
  category: "humanoid",
