...
const STRUCTURAL_CHECKS: SkillManifest["evaluation"]["structuralChecks"] =
  Object.freeze([
    Object.freeze({
      ...
      description: "The animal is a solid, non-trivial object.",
      options: {
    ...
    Object.freeze({
      ...
      description: "The animal is symmetric across the sagittal plane.",
      options: {
        axis: "x",
        plane: 12,
        region: { min: [0, 0, 0], max: [24, 16, 24] },
    ...
    Object.freeze({
      ...
      description: "The animal stays a small scene.",
...
const VISUAL_BASELINES: SkillManifest["evaluation"]["visualBaselines"] =
  Object.freeze([
    Object.freeze({
      view: "perspective",
      description: "The animal fills a visible share of the frame.",
      minSilhouetteRatio: 0.05,
      maxSilhouetteRatio: 0.9,
    } as const),
    Object.freeze({
      view: "side",
      description: "The side view shows the whole animal.",
      minSilhouetteRatio: 0.04,
      maxSilhouetteRatio: 0.9,
    } as const),
    Object.freeze({
      view: "top",
      description: "The top view shows the body.",
