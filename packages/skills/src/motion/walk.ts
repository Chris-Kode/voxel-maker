...
/**
 * Walk motion skill (plan S14.8, ticket #39): fixed instructions,
...
const MANIFEST: SkillManifest = {
  ...
  evaluation: {
    scenarioId: "skill-walk-v1",
    fixtureId: "motion-walk",
...
/** The authored skill.walk motion-skill manifest (validated on load). */
export const WALK_SKILL_MANIFEST = Object.freeze(MANIFEST);
