...
/**
 * Jump motion skill (plan S14.8, ticket #39): fixed instructions,
...
const STRUCTURAL_CHECKS: SkillManifest["evaluation"]["structuralChecks"] =
  Object.freeze([
    ...
    Object.freeze({
      ...
      description: "Every clip's duration stays within the jump range.",
      options: { min: 1, max: 2.5 },
    } as const),
    Object.freeze({
...
const MANIFEST: SkillManifest = {
  ...
  evaluation: {
    scenarioId: "skill-jump-v1",
    fixtureId: "motion-jump",
...
/** The authored skill.jump motion-skill manifest (validated on load). */
export const JUMP_SKILL_MANIFEST = Object.freeze(MANIFEST);
