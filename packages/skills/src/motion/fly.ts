...
const STRUCTURAL_CHECKS: SkillManifest["evaluation"]["structuralChecks"] =
  Object.freeze([
    ...
    Object.freeze({
      ...
      description: "The flap rate matches a wingbeat.",
      options: { min: 0.5, max: 2 },
    } as const),
    Object.freeze({
    ...
    Object.freeze({
      ...
      description: "The wings stay rigged.",
      options: { min: 2, max: 6 },
    } as const),
    Object.freeze({
    ...
    Object.freeze({
      name: "node-present",
      description: "The left wing node exists.",
      options: { nodeId: "node:rig:wings:left" },
    } as const),
  ]);
...
const MANIFEST: SkillManifest = {
  ...
  name: "skill.fly",
  version: "1.0.0",
  description: "flight of a rigged winged creature",
  kind: "motion",
  category: "fly",
  ...
  evaluation: {
    scenarioId: "skill-fly-v1",
    fixtureId: "motion-fly",
...
/** The authored skill.fly motion-skill manifest (validated on load). */
export const FLY_SKILL_MANIFEST = Object.freeze(MANIFEST);
